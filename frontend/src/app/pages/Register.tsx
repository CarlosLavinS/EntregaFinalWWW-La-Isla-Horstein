...
import { Mail, Lock, User, Phone, UserPlus, IdCard } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:border-red-600 transition-colors ${
                    errors.run ? 'border-red-500' : 'border-neutral-200'
                  }`}
                  placeholder="12.345.678-9"
                />
                {errors.run && (
                  <p className="text-red-500 text-sm mt-1">{errors.run}</p>
                )}
              </div>
