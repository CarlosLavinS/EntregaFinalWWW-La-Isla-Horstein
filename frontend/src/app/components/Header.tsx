      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-8">
            <button onClick={() => navigate('/')} className="text-neutral-700 hover:text-red-600 transition-colors">
              Menu
            </button>
            <button onClick={() => navigate('/about')} className="text-neutral-700 hover:text-red-600 transition-colors">
              Nosotros
            </button>
            <button onClick={() => navigate('/contact')} className="text-neutral-700 hover:text-red-600 transition-colors">
              Contacto
            </button>
          </nav>
